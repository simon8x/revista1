         ...
         <div class="col-md-8">
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="ad728-wrapper">
                     <!--a href="#">
                     <img src="http://autotest.com.ar/wp-content/themes/mototheme/images/banner-hor-720.jpg" alt="">
                     </a-->
         ...
         <div class="col-md-4">
            <aside class="sidebar">
               <div class="widget cus-adwidget">
                  <!--a href="#!">
                  <img src="http://autotest.com.ar/wp-content/themes/mototheme/images/banner-vertical.jpg" alt="">
                  </a-->
				  Twitter
               </div>
               <div class="widget cus-adwidget">
                  <!--a href="#!">
                  <img src="http://autotest.com.ar/wp-content/themes/mototheme/images/banner-vertical-large.jpg" alt="">
                  </a-->
   ...
   <div class="main-content mag-content clearfix">
      <div class="row blog-content">
         <div class="col-md-8">
			...
			$the_query = new WP_Query ($args);
			if ( $the_query->have_posts() ) : while ( $the_query->have_posts() ) :$the_query->the_post(); $v_aviso++?>
				
						
						<?php //if($v_aviso == 4 ) { echo "<div class='row'>"; }?>
					   <div class="col-md-6">
						  <article class="news-block small-block">
							 <a href="<?php the_permalink(); ?>" class="overlay-link">
								<figure class="image-overlay">
					   ...
					   </div><?php //if($v_aviso == 4 || $v_aviso ==6 ) { echo "</div>";} ?>
					   <?php if($v_aviso == 2) { ?>
							<div class="col-md-6">
								<div class="widget cus-adwidget" style="padding:0!important;">
