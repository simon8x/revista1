  ...
  <div class="main-content mag-content clearfix">
      ...
      <div class="row main-body-in" data-stickyparent>
        ...
        <div class="col-md-8">
          ...
          <h3 class="block-title hidden"><span>&Uacute;ltimas Pruebas</span></h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <article id="post-<?php the_ID(); ?>" <?php post_class('news-block small-block'); ?>>
									...
									<?php									    $terms = get_the_terms( get_the_id(), 'marca' );                                        if($terms != false):									?>                                    <div class="meta">                                        <a href="<?php echo get_term_link( $terms[0]->term_id ); ?>" class="taxo">                                            <?php echo $terms[0]->name; ?>                                        </a>                                        | <span><i class="fa fa-clock-o"></i> <?php the_time('d.m.y'); ?></span>                                    </div>									<?php										endif;									?>
                                    </header>
